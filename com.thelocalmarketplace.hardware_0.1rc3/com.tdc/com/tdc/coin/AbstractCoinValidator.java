...
/**
 * Abstract base class of components for optically and/or physically validating coins.
 * 
 * @author TDC, Inc.
 */
public abstract class AbstractCoinValidator extends AbstractComponent<CoinValidatorObserver>
	implements Sink<Coin>, PassiveSource<Coin> {
	/**
	 * Represents the kind of currency supported by this component.
	 */
	public final Currency currency;
	protected List<BigDecimal> denominations;
	/**
	...
	private static final int PROBABILITY_OF_FALSE_REJECTION = 1;

	protected AbstractCoinValidator(Currency currency, Map<BigDecimal, Sink<Coin>> standardSinks) {
		super();
